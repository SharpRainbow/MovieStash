...
class CollectionAdapter(private val cols: List<Collection>,
    ...
    private var startColors = intArrayOf(Color.parseColor("#f7c0ec"), Color.parseColor("#b9dcf2"),
        Color.parseColor("#d3f3f1"), Color.parseColor("#9bf8f4"), Color.parseColor("#f9c58d"),
        Color.parseColor("#ebf4f5"))
    private var endColors = intArrayOf(Color.parseColor("#a7bdea"), Color.parseColor("#f6cfbe"),
        Color.parseColor("#e9b7ce"), Color.parseColor("#6f7bf7"), Color.parseColor("#f492f0"),
    ...
    override fun onBindViewHolder(holder: ColViewHolder, position: Int) {
        ...
        val drawable = GradientDrawable(
            ...
            intArrayOf(startColors[sel], endColors[sel])
        )
